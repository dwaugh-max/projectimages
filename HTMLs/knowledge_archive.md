# Classroom Sim Architect: Knowledge Archive (v65.7 - synced with codebase)
...
Provide a concise assessment (150 words). Format with markdown.`;
        ...
        function tab(el, tName) {
            ...
            if (isYouTube) {
                ...
                if (vidId) {
                    h = `<iframe src="https://www.youtube.com/embed/${vidId}?rel=0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width:100%;height:100%;border:none;" referrerpolicy="no-referrer"></iframe>`;
                } else {
