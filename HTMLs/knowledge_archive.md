# Classroom Sim Architect: Knowledge Archive (v65.30 - synced with codebase)
...
<body>
    ...
    <script>
        ...
        function applyTheme() {
            ...
            document.getElementById('f-left').innerHTML = `${m.title || currentMission} | SITUATION ROOM PROTOCOL v65.30`;
